<template>
  <div style="position: relative;" >
    <div id="search-container" style="margin:10px 20px;">
      <el-row>
          <el-col :span="18">
            <div class="fl">
          ...
          <el-col :span="4">
            <div class="fr">
              <el-search-form class="searchBox" @searchClick="searchClick" @inputChange="inputChange">
              </el-search-form>
            </div>
          </el-col>
          <el-col :span="2">
    ...
    <el-template :pkTemp="pk_temp" :templateValue="value" @edit-table-row="editTableRow" :show-button="true" show-type="index" style="height:400px;" :sortable="true"></el-template>
    <el-pagination
