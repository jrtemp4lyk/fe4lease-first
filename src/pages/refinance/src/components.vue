<template>
    ...
    <form class="formBox" v-else>
        ...
        <!-- 底部操作按钮 -->
        <el-row v-if="formStyle && formStyle.showButtons">
            <el-col style="text-align:left; margin-bottom:15px; margin-left:20px">
                <el-button size="primary" @click="onSubmit" >保存</el-button>
                <el-button size="primary" @click="onCancel"  :plain="true">取消</el-button>
            </el-col>
        </el-row>
    </form>
</template>
